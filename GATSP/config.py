...
data_arg.add_argument('--city_num', type=int, default=60, help='city num')  # 城市数量
data_arg.add_argument('--pos_dimension', type=int, default=2, help='city num')  # 坐标维度
data_arg.add_argument('--individual_num', type=int, default=60, help='individual num')  # 个体数 比如一个裙子就是60个
data_arg.add_argument('--gen_num', type=int, default=8000, help='generation num')  # 迭代轮数
